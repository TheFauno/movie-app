...
class App extends React.Component {
  ...
  getMovies(searchString = '') {
    let url = 'https://www.omdbapi.com/?i=tt3896198&apikey='+process.env.REACT_APP_OMDBAPI_KEY+'&type=movie';
  ...
  callbackSelectedDetailMovie(selectedImdbID) {
    ...
    const url = 'https://www.omdbapi.com/?apikey='+process.env.REACT_APP_OMDBAPI_KEY+'&plot=full&type=movies&i=';
    fetch(url+imdbID)
      .then(res => res.json())
      .then((data) => {
